...
<div class="card shadow-sm">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('admin.draft.store') }}" method="POST" class="needs-validation" novalidate>
            @csrf
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" id="type" name="type" class="form-control" placeholder="SMS Type" required>
                ...
                <div class="col-12">
                    ...
                    <textarea id="message" name="message" class="form-control" rows="5" placeholder="Write message..." required></textarea>
