<aside class="sidebar offcanvas-lg offcanvas-start" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
    ...
    <nav class="nav" aria-label="Main navigation">
        ...
        <!-- Member Management -->
        <div class="nav-group">
            <div class="nav-group-label">Member Management</div>
            <a class="nav-item {{ request()->routeIs('admin.members.bulk-upload*') ? 'active' : '' }}" href="{{ route('admin.members.bulk-upload') }}" data-panel="members">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <a class="nav-item {{ request()->routeIs('admin.members.index') || request()->routeIs('admin.members.edit*') ? 'active' : '' }}" href="{{ route('admin.members.index') }}" data-panel="owners">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
