    ...
    <div class="col-12 col-md-10 col-lg-8 col-xl-7">
      ...
      <div class="card p-4">
        ...
        <div class="card-head pb-3 mb-4">
          <div>
            <h3 class="mb-1">Add New Plot Type</h3>
            <span class="hint">Define plot type name, fee, and status.</span>
          </div>
        </div>

        <form action="{{ route('admin.plot_type.store') }}" method="POST" autocomplete="off" class="d-flex flex-column gap-3">
          @csrf
